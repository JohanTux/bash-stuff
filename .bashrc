...
#aliases from johantux
alias nethack='telnet nethack.alt.org'
alias artserve='php artisan serve --host=192.168.1.177 --port=8000'
alias goodwill='cd ~/development/project-goodwill/'
...
export PATH=$PATH:$HOME/programming/PHPStorm/bin
